...
const i18n = new I18n({
  en: {
    ...
    count: "Count",
    situationPlaceHolder: "Describe e.g. Appearance elements of the other person, activity, behavior, atmosphere, etc.",
    talkingtoPlaceholder: "Specify gender",
    ...
    outputStyle: "Conversation Style (optional)",
  ...
  de: {
    ...
    count: "Anzahl",
    situationPlaceHolder: "Beschreiben z. B. Erscheinungselemente der anderen Person, Aktivität, Verhalten, Atmosphäre usw.",
    ...
    searchPlaceHolder: "Du kannst hier ALLES eingeben",
...
gr: {
  ...
  chooseLabel: "Επέλεξε ή πληκτρολόγησε που βρίσκεσαι",
  searchPlaceHolder: "Μπορείτε να πληκτρολογήσετε ΟΤΙΔΗΠΟΤΕ εδώ",
  ...
  freeCTAText:"Όχι, θέλω την πίτσα με μια έξτρα στρωση σάλτσας από τύψεις",
  freeTextAndIcons1: "Μόνο 2 δημιουργίες ανά ημέρα",
  freeTextAndIcons2: "Περιορισμένες συμβουλές από Ειδικούς",
  freeTextAndIcons3: "Χωρίς επιπλέον υπηρεσιες",
